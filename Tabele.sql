...
ID_Dystrybutora char(12) NOT NULL FOREIGN KEY REFERENCES Dystrybutor(ID_Dystrybutora) ON DELETE NO ACTION ON UPDATE NO ACTION
CHECK (LEFT(ID_Dystrybutora, 2) = '00'
AND SUBSTRING(ID_Dystrybutora, 3, 10) LIKE '%[0-9]%'),
ID_Rezysera char(12) NOT NULL FOREIGN KEY REFERENCES Rezyser(ID_Rezysera) ON DELETE CASCADE ON UPDATE CASCADE
...
ID_Aktora char(12) NOT NULL FOREIGN KEY REFERENCES Aktor(ID_Aktora) ON DELETE CASCADE ON UPDATE CASCADE 
...
CHECK (LEFT(ID_produkcji, 2) = '10'
AND SUBSTRING(ID_produkcji, 3, 10) LIKE '%[0-9]%'),
ID_Widza char(12) NOT NULL FOREIGN KEY REFERENCES Widz(ID_Widza) ON DELETE CASCADE ON UPDATE CASCADE
...
ID_Wystepu char(12) NOT NULL FOREIGN KEY REFERENCES Wystepy(ID_Wystepu) ON DELETE CASCADE ON UPDATE CASCADE
CHECK (LEFT(ID_Wystepu, 2) = '33'
AND SUBSTRING(ID_Wystepu, 3, 10) LIKE '%[0-9]%'),
